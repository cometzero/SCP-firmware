...
/* SI0<->AP Domain 1 Secure MHUv3 doorbell channel configuration */
struct mod_mhu3_channel_config si02ap_domain1_s_dbch_config
...
/* SI0<->AP Domain 3 Secure MHUv3 doorbell channel configuration */
struct mod_mhu3_channel_config si02ap_domain3_s_dbch_config
...
static const struct fwk_element mhu_element_table[]  = {
    ...
    [SI0_CFGD_MOD_MHU3_EIDX_SI0_AP_DOMAIN1_S] = {
        .name = "SI02AP_DOMAIN1_S_MHU_DBCH",
        .sub_element_count = FWK_ARRAY_SIZE(si02ap_domain1_s_dbch_config),
        .data = &(struct mod_mhu3_device_config) {
            .irq = (unsigned int) CL0_MHU3_AP2SI0_DOMAIN1_S_IRQ,
            .in = SI0_AP2SI0_DOMAIN1_S_MHUV3_RCV_BASE,
            .out = SI0_SI02AP_DOMAIN1_S_MHUV3_SEND_BASE,
            .channels = si02ap_domain1_s_dbch_config,
            .timer_id = FWK_ID_ELEMENT_INIT(FWK_MODULE_IDX_TIMER, 0),
            .resp_wait_timeout_us = RESP_WAIT_TIMEOUT_US,
        },
    },
    [SI0_CFGD_MOD_MHU3_EIDX_SI0_AP_DOMAIN3_S] = {
        .name = "SI02AP_DOMAIN3_S_MHU_DBCH",
        .sub_element_count = FWK_ARRAY_SIZE(si02ap_domain3_s_dbch_config),
        .data = &(struct mod_mhu3_device_config) {
            .irq = (unsigned int) CL0_MHU3_AP2SI0_DOMAIN3_S_IRQ,
            .in = SI0_AP2SI0_DOMAIN3_S_MHUV3_RCV_BASE,
            .out = SI0_SI02AP_DOMAIN3_S_MHUV3_SEND_BASE,
            .channels = si02ap_domain3_s_dbch_config,
            .timer_id = FWK_ID_ELEMENT_INIT(FWK_MODULE_IDX_TIMER, 0),
            .resp_wait_timeout_us = RESP_WAIT_TIMEOUT_US,
        },
    },
