...
static const struct fwk_element fch_polled_element_table[] = {
    [RDASPEN_PLAT_FCH_CLUSTER0_PERF_LEVEL_SET] = FCH_LEVEL_SET_ENTRY(0),
    [RDASPEN_PLAT_FCH_CLUSTER0_PERF_LIMIT_SET] = FCH_LIMIT_SET_ENTRY(0),
    [RDASPEN_PLAT_FCH_CLUSTER0_PERF_LEVEL_GET] = FCH_LEVEL_GET_ENTRY(0),
    [RDASPEN_PLAT_FCH_CLUSTER0_PERF_LIMIT_GET] = FCH_LIMIT_GET_ENTRY(0),

    [RDASPEN_PLAT_FCH_CLUSTER1_PERF_LEVEL_SET] = FCH_LEVEL_SET_ENTRY(1),
    [RDASPEN_PLAT_FCH_CLUSTER1_PERF_LIMIT_SET] = FCH_LIMIT_SET_ENTRY(1),
    [RDASPEN_PLAT_FCH_CLUSTER1_PERF_LEVEL_GET] = FCH_LEVEL_GET_ENTRY(1),
    [RDASPEN_PLAT_FCH_CLUSTER1_PERF_LIMIT_GET] = FCH_LIMIT_GET_ENTRY(1),

    [RDASPEN_PLAT_FCH_CLUSTER2_PERF_LEVEL_SET] = FCH_LEVEL_SET_ENTRY(2),
    [RDASPEN_PLAT_FCH_CLUSTER2_PERF_LIMIT_SET] = FCH_LIMIT_SET_ENTRY(2),
    [RDASPEN_PLAT_FCH_CLUSTER2_PERF_LEVEL_GET] = FCH_LEVEL_GET_ENTRY(2),
    [RDASPEN_PLAT_FCH_CLUSTER2_PERF_LIMIT_GET] = FCH_LIMIT_GET_ENTRY(2),

    [RDASPEN_PLAT_FCH_CLUSTER3_PERF_LEVEL_SET] = FCH_LEVEL_SET_ENTRY(3),
    [RDASPEN_PLAT_FCH_CLUSTER3_PERF_LIMIT_SET] = FCH_LIMIT_SET_ENTRY(3),
    [RDASPEN_PLAT_FCH_CLUSTER3_PERF_LEVEL_GET] = FCH_LEVEL_GET_ENTRY(3),
    [RDASPEN_PLAT_FCH_CLUSTER3_PERF_LIMIT_GET] = FCH_LIMIT_GET_ENTRY(3),

    [RDASPEN_PLAT_FCH_COUNT] = { 0 },
};
