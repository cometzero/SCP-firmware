...
set(SCP_FIRMWARE "apollo-qvp-si0-bl2")
set(SCP_FIRMWARE_TARGET "apollo-qvp-si0-bl2")
...
if (NOT DEFINED SCP_PFDI_OOR_PERIOD_US)
    set(SCP_PFDI_OOR_PERIOD_US 5000000UL)
endif()

if (NOT DEFINED SCP_PFDI_BOOT_TIMEOUT_US)
    set(SCP_PFDI_BOOT_TIMEOUT_US 50000000UL)
endif()
...
if (NOT DEFINED SCP_SICL1_PFDI_OOR_PERIOD_US)
    set(SCP_SICL1_PFDI_OOR_PERIOD_US 1000000UL)
endif()

if (NOT DEFINED SCP_SICL1_PFDI_BOOT_TIMEOUT_US)
    set(SCP_SICL1_PFDI_BOOT_TIMEOUT_US 10000000UL)
endif()
